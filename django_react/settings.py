...
SECRET_KEY = 'django-insecure-28_y=r%23e_4nw(7jrj^nv)v^ml%zre^q%d01ego#0vfs9_=f8'
...
CORS_ALLOW_CREDENTIALS = True  # Allow session cookies to be sent
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # <-- assumes your Webpack output is under /static
]
